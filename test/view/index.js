...
*/
class Untitled_View extends HTMLElement
{
    ...
    connectedCallback()
    {
        ...
        this.freqListener = value => 
            {
                console.log("freqListener", value);
...
window.customElements.define ("untitled-view", Untitled_View);
...
{
    return new Untitled_View (patchConnection);
}
